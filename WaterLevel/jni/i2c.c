...
#include "ch_bfh_ti_waterlevel_I2C.h"
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_waterlevel_I2C_open(JNIEnv *env, jobject obj, jstring file)
  {
   #ifndef EMULATOR
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_waterlevel_I2C_read(JNIEnv * env, jobject obj, jint fileHander, jintArray bufArray, jint len)
...
JNIEXPORT jint JNICALL Java_ch_bfh_ti_waterlevel_I2C_write(JNIEnv *env, jobject obj, jint fileHander, jintArray inJNIArray, jint len)
 {
  #ifndef EMULATOR
...
JNIEXPORT void JNICALL Java_ch_bfh_ti_waterlevel_I2C_close(JNIEnv *env, jobject obj, jint fileHander)
 {
   #ifndef EMULATOR
    close(fileHander);
   #endif
